...
{ 
  ...
  write_addr(0x40002003, 0x00000300); //LCR
	...
	write_addr(0x40002001, 0x00000700); //IER
  ...
  write_addr(0x40002001, 0x00000005); //DLM
	write_addr(0x40002000, 0x00000005); //DLL
	write_addr(0x40002003, 0x00000000); //Disable bit
  write_addr(0x40002003, 0x00000300); //LCR
  ...
  write_addr(0x40002001, 0x0000000a); //DLM
	write_addr(0x40002000, 0x0000000a); //DLL
	write_addr(0x40002003, 0x00000000); //Disable bit
  write_addr(0x40002003, 0x00000300); //LCR
	write_addr(0x40002001, 0x00000000); //IER
  ...
  write_addr(0x40002003, 0x00000300); //LCR
	write_addr(0x40002001, 0x00000000); //IER
	write_addr(0x40002002, 0x00060000); //FCR
	write_addr(0x40002005, 0x00000000); //LSR
