...
{ 
	...
	for(i=0;i<16;i++){
		...
		j = read_addr((SRAM_A_base_ADDR+(i*16)));
	}
	
	for(i=0;i<16;i++){
		write_addr((0x2000fff0+(i*16)),((i*20)+1));
		j = read_addr((0x2000fff0+(i*16)));
	}
	
	for(i=0;i<16;i++){
		write_addr((0x20020000-(i*16)),((i*30)+1));
		j = read_addr((0x20020000-(i*16)));
	}
